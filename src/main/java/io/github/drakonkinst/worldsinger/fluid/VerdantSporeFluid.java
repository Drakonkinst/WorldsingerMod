...
public abstract class VerdantSporeFluid extends LivingAetherSporeFluid {
    ...
    protected BlockState toBlockState(FluidState fluidState) {
        return ModBlocks.VERDANT_SPORE_SEA.getDefaultState().with(Properties.LEVEL_15,
    ...
    protected void doWaterReaction(World world, BlockPos pos, int sporeAmount,
        ...
        VerdantSporeManager.spawnVerdantSporeGrowth(world, pos.toCenterPos(), sporeAmount,
