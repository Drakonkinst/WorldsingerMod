...
public final class VerdantSporeManager {

    public static final double SAME_GROWTH_SEARCH_RADIUS = 3.0;
    ...
    public static void spawnVerdantSporeGrowth(World world, Vec3d pos, int spores, int water,
        ...
        spawnVerdantSporeGrowth(world, pos, spores, water, initialGrowth,
    ...
    public static void spawnVerdantSporeGrowth(World world, Vec3d pos, int spores, int water,
        ...
        if (!isSplit && checkForNearbyNewVerdantGrowth(world, pos, spores, water,
