...
public class FogModifier {
    ...
    public boolean test(FogContext context) {
        return isBiome(context) ? FogModifiers.testBiomeKey(context, biomeRegistryKey -> biomeRegistryKey.equals(biomeKey)) && predicate.test(context) : predicate.test(context);
    }
