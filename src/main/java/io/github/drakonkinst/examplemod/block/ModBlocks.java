...
public final class ModBlocks {
  ...
  public static final Block VERDANT_SPORE_SEA_BLOCK =
      register(new AetherSporeFluidBlock(ModFluids.VERDANT_SPORES, FabricBlockSettings.create()
          .strength(100.0f)
  ...
  public static final Block VERDANT_SPORE_BLOCK =
      register(new AetherSporeBlock(ModBlocks.VERDANT_SPORE_SEA_BLOCK, FabricBlockSettings.create()
          .strength(0.5f)
          .mapColor(MapColor.DARK_GREEN)
